...
def upgrade():
    ...
    op.add_column('match', sa.Column(
        'possession_first_half_home', sa.Integer(), nullable=True))
    op.add_column('match', sa.Column(
        'possession_first_half_away', sa.Integer(), nullable=True))
    op.add_column('match', sa.Column(
        'possession_second_half_home', sa.Integer(), nullable=True))
    op.add_column('match', sa.Column(
        'possession_second_half_away', sa.Integer(), nullable=True))
    op.add_column('match', sa.Column(
        'home_team_chances_left', sa.Integer(), nullable=True))
    op.add_column('match', sa.Column(
        'home_team_chances_center', sa.Integer(), nullable=True))
    op.add_column('match', sa.Column(
        'home_team_chances_right', sa.Integer(), nullable=True))
    op.add_column('match', sa.Column(
        'home_team_chances_special', sa.Integer(), nullable=True))
    op.add_column('match', sa.Column(
        'home_team_chances_other', sa.Integer(), nullable=True))
    op.add_column('match', sa.Column(
        'away_team_chances_left', sa.Integer(), nullable=True))
    op.add_column('match', sa.Column(
        'away_team_chances_center', sa.Integer(), nullable=True))
    op.add_column('match', sa.Column(
        'away_team_chances_right', sa.Integer(), nullable=True))
    op.add_column('match', sa.Column(
        'away_team_chances_special', sa.Integer(), nullable=True))
    op.add_column('match', sa.Column(
        'away_team_chances_other', sa.Integer(), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('match', sa.Column('home_team_shots_on_target',
                  sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('match', sa.Column('home_team_possession', sa.DOUBLE_PRECISION(
        precision=53), autoincrement=False, nullable=True))
    op.add_column('match', sa.Column('away_team_shots_on_target',
                  sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('match', sa.Column('home_team_shots',
                  sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('match', sa.Column('away_team_shots',
                  sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('match', sa.Column('home_team_tackles',
                  sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('match', sa.Column('away_team_possession', sa.DOUBLE_PRECISION(
        precision=53), autoincrement=False, nullable=True))
    op.add_column('match', sa.Column('away_team_tackles',
                  sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('match', sa.Column('away_team_passes',
                  sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('match', sa.Column('home_team_passes',
                  sa.INTEGER(), autoincrement=False, nullable=True))
