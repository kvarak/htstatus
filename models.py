...
class Players(db.Model):
  ...
  is_transfer_listed   = db.Column(db.Integer)
  ...
  def __init__(self, playerdata):
    ...
    self.stamina              = playerdata.stamina
    self.keeper               = playerdata.keeper
    self.defender             = playerdata.defender
    self.playmaker            = playerdata.playmaker
    self.winger               = playerdata.winger
    self.passing              = playerdata.passing
    self.scorer               = playerdata.scorer
    self.set_pieces           = playerdata.set_pieces
