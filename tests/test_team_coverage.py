...
class TestTeamBlueprintAdvanced:
    ...
    def test_setup_team_blueprint_initialization(self, mock_app, mock_db):
        ...
        setup_team_blueprint(
            mock_app, mock_db, "test_ck", "test_cs", "v1.0", "v1.0-full"
        )
    ...
    def test_update_route_initialization_success(
        self,
        mock_dprint,
        mock_get_chpp,
        mock_get_teams,
    ...
    @patch("app.blueprints.team.get_user_teams")
    @patch("app.blueprints.team.dprint")
    def test_update_route_chpp_initialization_error(
        self,
        mock_dprint,
        mock_get_teams,
        mock_get_user_id,
    ...
    def test_update_route_youth_team_id_error_handling(
        self,
        mock_dprint,
        mock_get_teams,
        mock_get_user_id,
        ...
        with mock_app.app_context():
            ...
            assert any(
                "YouthTeamId" in str(call) for call in mock_dprint.call_args_list
            )
    ...
    def test_team_route_user_activity_tracking(
        self,
        mock_create_page,
        mock_fetch_teams,
        mock_get_chpp,
        ...
        with mock_app.app_context(), patch("flask.session", {"current_user_id": 12345}):
            team()
            ...
            mock_create_page.assert_called_once_with(template="team.html", title="Team")
    ...
    @patch("app.blueprints.team.create_page")
    @pytest.mark.skip(reason="Template not found: _forward.html")
    def test_team_route_no_current_user(
        self,
        mock_create_page,
        mock_fetch_teams,
        mock_get_chpp,
    ...
    def test_update_route_critical_error_handling(
        self,
        mock_dprint,
        mock_get_teams,
        mock_get_user_id,
        ...
        with mock_app.app_context():
            ...
            assert any(
                "CRITICAL ERROR" in str(call) for call in mock_dprint.call_args_list
            )
